...
namespace ES3Types
{
	...
	public class ES3Type_Light : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			// Keep the existing scalar save key for backwards compatibility.
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "spotAngle":
						...
						break;
					case "cookieSize":
						instance.cookieSize2D = UnityEngine.Vector2.one * reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "cookie":
